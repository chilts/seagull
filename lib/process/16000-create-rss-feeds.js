...
module.exports = function createRssFeeds (ctx, callback) {
  ...
  visitEveryDir(
    ...
    function (url, dir, done) {
      ...
      createFeed(ctx, url, dir, ctx.cfg.title, ctx.cfg.protocol + '://' + ctx.cfg.domain + url, ctx.cfg.authorName, ctx.cfg.authorEmail, posts, 'feed.rss')
